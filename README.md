...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a8h2ddu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a8h2ddu.containers.anotherwebservice.com/
...
```
git clone git@github.com:debugtitan/container-a8h2ddu.git
cd container-a8h2ddu
```
...
```
docker attach container-a8h2ddu
```
